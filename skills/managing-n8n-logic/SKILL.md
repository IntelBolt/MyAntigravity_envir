...
## 0. Knowledge Base & Documentation
**ОБЯЗАТЕЛЬНОЕ ПРАВИЛО:** При выполнении любых задач, связанных с n8n, всегда используй MCP-сервер `n8n-kb` для поиска официальной документации, проверенных шаблонов (templates) и примеров настройки узлов. Это минимизирует ошибки в конфигурации и помогает использовать лучшие практики.
